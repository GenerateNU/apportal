...
const interviewReviewAssignmentColumns = `id, application_id, tl_nuid, assigned_by, assigned_at`
...
// CreateInterviewReviewAssignment assigns a TL to review the recording.
func (s *Store) CreateInterviewReviewAssignment(ctx context.Context, applicationID, tlNUID, assignedBy string) (models.InterviewReviewAssignment, error) {
	const q = `
		INSERT INTO interview_review_assignments (application_id, tl_nuid, assigned_by)
		VALUES ($1, $2, $3)
