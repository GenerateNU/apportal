...
export function ApplicantRow({ applicant }: { applicant: Applicant }) {
  return (
    <tr className="cursor-pointer border-b border-gray-100 hover:bg-gray-50">
      <td className="px-4 py-3 text-sm font-medium text-text-default">
        {applicant.firstName} {applicant.lastName}
      </td>
      <td className="px-4 py-3 text-sm text-text-muted">{applicant.nuid}</td>
      <td className="px-4 py-3 text-sm text-text-muted">{applicant.email}</td>
      <td className="px-4 py-3 text-sm text-text-muted">{applicant.major}</td>
      <td className="px-4 py-3 text-sm text-text-muted">{applicant.year}</td>
